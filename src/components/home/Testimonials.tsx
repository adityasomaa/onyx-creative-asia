...
export default function Testimonials() {
  ...
  return (
    <section className="bg-ink text-bone overflow-hidden">
      <div className="border-t border-hairline-light py-24 md:py-32">
      <div className="container-x text-center">
        ...
        <p className="mx-auto mt-5 max-w-xl text-base md:text-lg text-bone/70 leading-relaxed">
          {t(
      ...
      <div className="relative mt-12 md:mt-16">
        ...
        <div className="flex w-max gap-5 animate-marquee md:gap-6">
          {row.map((item, i) => (
            <figure
              key={i}
              className="flex w-[300px] shrink-0 flex-col rounded-2xl border border-hairline-light p-6 md:w-[420px] md:p-8"
            >
              <blockquote className="text-base md:text-lg leading-relaxed text-bone/85">
