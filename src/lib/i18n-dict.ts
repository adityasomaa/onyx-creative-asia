 ...
 * ============================================================ */
const SERVICE_TX: Record<string, ServiceTx> = {
  // Rebrand 2026: the seven-service taxonomy replaced the six, so
  // every previous entry described a service that no longer exists.
  // Rewriting them is a content job of its own; until then services
  // render in English rather than in someone else's words.
};
